...
-- tab
vim.keymap.set('n', key.ctrl_with_leader_keymap_set(key.ctrl_prefix, "k"), "<CMD>tabprevious<CR>", { desc = "Move previous tab" })
vim.keymap.set('n', key.ctrl_with_leader_keymap_set(key.ctrl_prefix, "j"), "<CMD>tabnext<CR>", { desc = "Move next tab" })
vim.keymap.set('n', key.ctrl_with_leader_keymap_set(key.ctrl_prefix, "t"), "<CMD>tabnew<CR>", { desc = "New empty tab" })
